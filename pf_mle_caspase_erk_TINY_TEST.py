...
def systematic_resample(weights: np.ndarray, rng: np.random.Generator) -> np.ndarray:
    """Return ancestor indices using systematic resampling."""
    n = len(weights)
...
def main() -> None:
    ...
    print("  4. Death-only data may not identify all caspase and ERK parameters at once;")
